...
class FileUtils {
  ...
  static void saveFileWithFlutterDownloader({
    required String url,
  ...
  static String getFileNameFromUrl(String? videoUrl) {
    if (videoUrl != null) {
  ...
  static Future<File> cacheFileUsingWriteAsString({
    ...
    final name = getFileNameFromUrl(videoUrl);
    ...
    return await file.writeAsString(contents).catchError((err) {
